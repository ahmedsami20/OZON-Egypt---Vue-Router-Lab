            ...
            <div class="contact-item mb-3">
              <div class="d-flex align-items-start">
                ...
                <div>
                  <h6>Phone</h6>
                  <p class="text-muted mb-0">
                    <a href="tel:+20 10 60475229" class="text-decoration-none">
                      +20 10 60475229
                    </a><br>
                    <small>Saturday - Thursday : 9:00 AM - 6:00 PM</small>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="contact-item mb-3">
              <div class="d-flex align-items-start">
                ...
                <div>
                  <h6>Email</h6>
                  <p class="text-muted mb-0">
                    <a href="mailto:ahmedsami20996@gmail.com" class="text-decoration-none">
                      ahmedsami20996@gmail.com
                    </a><br>
                    <a href="mailto:ahmedsami20996@gmail.com" class="text-decoration-none">
                      support@OZON-egypt.com
                    </a>
                  </p>
                </div>
              </div>
        ...
        <div class="card">
          ...
          <div class="card-body text-center">
            <div class="social-links">
              <a href="https://www.facebook.com/share/14GB7f9rrDR/" class="btn btn-outline-primary btn-social me-2 mb-2">
                <i class="fab fa-facebook-f"></i>
              </a>
              <a href="https://x.com/AhmedSa22217103?t=FW4wBLQnBV5TC-dp80GH9A&s=09" class="btn btn-outline-info btn-social me-2 mb-2">
                <i class="fab fa-twitter"></i>
              </a>
              <a href="#" class="btn btn-outline-danger btn-social me-2 mb-2">
                <i class="fab fa-instagram"></i>
              </a>
              <a href="https://wa.me/201060475229" class="btn btn-outline-success btn-social mb-2">
